...
setup do
  ...
  test "should be set to be delivred to the users from the order passed in" do
    ...
    assert_match "You ordered #{@order.products.count} products", mail.body.encoded  end
end
